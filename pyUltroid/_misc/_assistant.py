...
IN_BTTS = [
    [
        Button.url(
            "Repository",
            url="https://github.com/SpaceNetworkDev/Verly",
        ),
        Button.url("Support", url="https://t.me/VerlySupportChat"),
    ]
]
            ...
            if owner and event.sender_id not in owner_and_sudos():
                res = [
                    await event.builder.article(
                        title="Verly Userbot",
                        url="https://t.me/SpaceNetworkEU",
                        description="(c) Space Network",
                        text=MSG,
                        thumb=InputWebDocument(
                            "https://i.imgur.com/WgcUSPc.png",
                            0,
                            "image/jpeg",
                            [],
                        ),
                    ...
                    await event.answer(
                        [
                            await event.builder.article(
                                ...
                                text=error_text(),
                                buttons=Button.url(
                                    "Report", "https://t.me/VerlySupportChat"
                                ),
                            )
                        ]
                    )
